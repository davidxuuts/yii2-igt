...
namespace davidxu\igt\protobuf;

use davidxu\igt\protobuf\encoding\Base128varint;
use davidxu\igt\protobuf\reader\PBInputStringReader;
use davidxu\igt\protobuf\type\PBInt;
use davidxu\igt\protobuf\type\PBString;
...
class PBMessage
{
    ...
    // pointer to begin
    /**
     * @var PBInputStringReader $reader
     */
    protected $reader;
    ...
    /**
     * PBMessage Constructor - initialize base128 class
     * @param null $reader
     */
     ...
     *
     * @param mixed $message The messages stream of hex example '1a 03 08 96 01'
     */
    ...
    protected function _add_arr_value($index)
    {
        ...
        return $this->values[$index][] = new $name();
//        return $this->values[$index][] = new $this->fields[$index]();
     ...
     * Set an array value
     * @param int $index - index of the field
     * @param int $index_arr- index of the array
    ...
    /**
     * Set an value
     * @param integer $index - index of the field
     * @param mixed $value
     */
...
//            $this->values[$index] = new $this->fields[$index]();
    ...
    /**
     * Get a value
     * @param integer $index id of the field
     * @return mixed
     */
